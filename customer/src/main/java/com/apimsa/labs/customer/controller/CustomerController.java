package com.apimsa.labs.customer.controller;
...
import com.apimsa.labs.customer.domain.service.CustomerService;
...
public class CustomerController {
    ...
    public List<Customer> findByCustomerId(@RequestParam(value="customerId") String customerId) {
